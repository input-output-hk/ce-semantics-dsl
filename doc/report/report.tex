...
\todo{We may want to explain other stuff related to semantics, like evaluation order or strictness vs laziness, and how we basically assume ``just Scala semantics'' here.}%
